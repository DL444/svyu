...
final class ComposerSingleChoiceQuestionView extends ComposerQuestionViewBase {

    public static ComposerSingleChoiceQuestionView createInstance(IQuestionViewModel question) {
        ComposerSingleChoiceQuestionView fragment = new ComposerSingleChoiceQuestionView();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            question = (SingleChoiceQuestionViewModel) getArguments().getSerializable("question");
        }
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.composer_single_choice_view, container, false);
    }
    ...
    private Button.OnClickListener confirmListener = new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            ComposerSingleChoiceQuestionView.this.getAddQuestionCompleteCallback().onAddQuestionComplete(question);
        }
    };
    ...
    private SingleChoiceQuestionViewModel question;
}
